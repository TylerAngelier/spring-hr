...
--changeset trangelier:schema-init-seed-data
...
COMMIT;
-- rollback delete job_history;
-- rollback delete employees;
-- rollback delete jobs;
-- rollback delete departments;
-- rollback delete locations;
-- rollback delete countries;
-- rollback delete regions;